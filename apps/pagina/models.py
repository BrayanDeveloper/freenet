...
class About(models.Model):
    ...
    text_aling = models.CharField(max_length=100)
    ...
    border_radius = models.CharField(max_length=100)
...
class Team(models.Model):
    ...
    profession = models.CharField(max_length=900)
    width_text = models.CharField(max_length=900)
    height_text = models.CharField(max_length=900)
    ...
    icon1 = models.ImageField(upload_to='static/img/images_social/')
    link_icon1 = models.CharField(max_length=2000)
    icon2 = models.ImageField(upload_to='static/img/images_social/')
    link_icon2 = models.CharField(max_length=2000)
    icon3 = models.ImageField(upload_to='static/img/images_social/')
    link_icon3 = models.CharField(max_length=2000)
    icon4 = models.ImageField(upload_to='static/img/images_social/')
    link_icon4 = models.CharField(max_length=2000)
